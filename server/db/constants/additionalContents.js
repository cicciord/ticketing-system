...
module.exports = [
  {
    author_id: 2,
    ticket_id: 1,
    timestamp: dayjs("2009-01-04T08:23:45").unix(),
    text: `Satoshi,
...
Hal`,
  },
  {
    author_id: 1,
    ticket_id: 1,
    timestamp: dayjs("2009-01-05T14:57:01").unix(),
    text: `Hal,
...
Satoshi`,
  },
  {
    author_id: 2,
    ticket_id: 2,
    timestamp: dayjs("2009-01-13T03:12:37").unix(),
    text: `Satoshi,
...
Hal Finney`,
  },
  {
    author_id: 3,
    ticket_id: 2,
    timestamp: dayjs("2009-01-14T19:45:22").unix(),
    text: `I’ve been analyzing the Bitcoin code and the recent transaction. The cryptographic principles and peer-to-peer network structure are solid. However, we need to keep a close watch on potential security vulnerabilities as more transactions occur.
...
Peter Todd`,
  },
  {
    author_id: 1,
    ticket_id: 2,
    timestamp: dayjs("2009-01-15T22:13:08").unix(),
    text: `To all,
...
Satoshi Nakamoto`,
  },
  {
    author_id: 3,
    ticket_id: 4,
    timestamp: dayjs("2014-11-16T06:49:33").unix(),
    text: `Vitalik,
...
Vitalik`,
  },
  {
    author_id: 5,
    ticket_id: 4,
    timestamp: dayjs("2022-03-22T00:02:59").unix(),
    text: `Vitalik,
...
Maxim`,
  },
  {
    author_id: 4,
    ticket_id: 5,
    timestamp: dayjs("2022-03-24T09:17:46").unix(),
    text: `Maxim,
